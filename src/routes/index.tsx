...
import processPackagingAsset from "@/assets/processo-embalagem-segura.webp.asset.json";
import kitCompletoAsset from "@/assets/kit-completo.webp.asset.json";
import suporteSuspensoAsset from "@/assets/suporte-suspenso.webp.asset.json";
...
import projeto4 from "@/assets/projeto-instalado-4.webp.asset.json";
...
import logoOlhoNaBrasa from "@/assets/logo-olho-na-brasa.webp.asset.json";
import card5Antes from "@/assets/card5-antes.webp.asset.json";
import card5Depois from "@/assets/card5-depois.jpg.asset.json";
import antesNovo from "@/assets/antes-novo.jpeg.asset.json";
import depoisNovo from "@/assets/depois-novo.webp.asset.json";
import kitRevestimento4 from "@/assets/kit-revestimento-4.webp.asset.json";
...
function FloatingWhatsappButton({ onOpenChat }: { onOpenChat: () => void }) {
  return (
    <button
      ...
      className="whatsapp-pulse fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-lg transition-transform duration-300 hover:scale-110"
    >
